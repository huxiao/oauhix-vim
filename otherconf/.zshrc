...
alias ocd='openocd -f interface/ftdi/jtagkey.cfg -f board/stm3210c_eval.cfg -f .openocd.cfg'
alias ocdcmd='telnet localhost 4444'
alias cmocd='openocd -f /usr/share/openocd/scripts/interface/cmsis-dap.cfg -f /usr/share/openocd/scripts/board/stm3210e_eval.cfg'
alias adb='arm-none-eabi-gdb -x gdbscript'
alias mkcs='find . -name "*.c" -o -name "*.h" > cscope.files && cscope -Rbq'
